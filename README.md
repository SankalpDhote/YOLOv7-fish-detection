**YOLOv7 Fish Detection Dataset**

This project uses YOLOv7 for fish detection and image processing.The dataset contains raw fish images, cropped images, and numbered outputs for training and testing object detection models.
